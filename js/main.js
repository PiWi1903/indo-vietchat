$(document).ready(function (e) {
    ...
    var n = document.querySelector(".country_action").innerHTML,
        ...
        (e.managerDialog = [
            {
                text: "Hai!<br>Saya Rudy Baldwin. Seorang pembaca Fisika dan Peramal.<br>",
            },
            {
                text: "Apakah Anda Laki-laki atau Perempuan?",
                m: {text: "Laki-laki"}, w: {text: "Perempuan"}
            },
            {
        ...
        (e.userZodiak = [
            {
                text: "Terima kasih, Menurut horoskop, Anda adalah - <p style='color: #3fc726'>{zodie}</p>. <p class='hidden-zodie' style='display: none'>{zodie}</p>"
            }
        ]),
        (e.managerVariants = {
            w: [
                [
                    [
                        {text: 'Kamu adalah orang yang sangat adil, selalu mendengarkan orang dari kedua sisi, tidak suka banyak bicara dan membenci kerumitan. Terkadang Anda banyak memikirkan suatu masalah, setelah memikirkannya, Anda akan membuat pilihan terbaik.'},
                        {text: '<br><img width="400px" src="img/2.jpeg"></br>'},
                        {text: "Jalur karier Anda seringkali penuh dengan kesulitan. Kebanyakan orang menentang Anda, itu karena kekuatan gelap menahan Anda sehingga hidup Anda tidak berjalan dengan baik. Jangan lewatkan apa pun, saya akan membantu Anda mengatasi hal-hal buruk yang menghambat Anda."},
                        {text: '<br><img width="400px" src="img/sep.jpeg"></br>'},
                        {text: 'Segala sesuatu tentang Anda menunjukkan bahwa Anda dilahirkan untuk bahagia, bahwa Anda lebih beruntung dari kebanyakan orang, dan bahwa pilihan Anda selalu benar dan melihat jauh ke depan. Saya akan membantu Anda menemukan nomor terakhir yang akan mengubah hidup Anda.'},
                        {text: "Untuk mengetahui takdir masa depan Anda, putar roda astrologi, ini akan memberi tahu Anda apa yang akan terjadi pada Anda dalam waktu dekat, Anda akan terhindar dari kesialan jika Anda memutar roda astrologi ini."},
                    ],
                    [
                        {text: " "},
                    ],
        ...
        (e.socNumber = [{
            text: "Silakan klik tombol di bawah ini"
        },]),
        (e.Forms = function (t) {
            e.FormsParams = {
                method: "POST",
